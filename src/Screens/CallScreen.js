  ...
  render() {
    return(
      <View style={{ flex: 1 }}>
        ...
        <TouchableOpacity style={[styles.btnStopCall, styles.shadow]} onPress={()=> this.props.navigation.goBack()}>
        ...
        <View style={styles.bottomBar}>
          <TouchableOpacity style={[styles.btnAction,this.props.onSound?{backgroundColor:"blue"}:null, styles.shadow]} onPress={()=> {this.clickEventListener()}}>
